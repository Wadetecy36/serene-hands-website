  ...
  return (
    <Layout>
      <section className="mx-auto max-w-2xl px-5 pb-24 pt-14 sm:px-8 sm:pt-20">
        <Link to="/resources" className="mb-6 inline-flex items-center gap-1.5 text-sm font-medium text-ink-soft hover:text-coral">
        ...
        <div className="mt-10 rounded-2xl border border-dashed border-mist-deep bg-mist/40 p-8 text-center text-sm text-ink-soft">
